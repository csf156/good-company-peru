...
-- ============================================================================
-- Dirección `solicitud` (amigo→rentador): Beto emisor, Ana receptora. El amigo
-- (Beto) es el EMISOR acá — invierte respecto al caso anterior.
-- ============================================================================
insert into public.invitaciones (id, emisor_id, receptor_id, tipo, alcance, estado)
...
-- e idempotencia sin interferir con las de arriba.
insert into public.invitaciones (id, emisor_id, receptor_id, tipo, alcance, estado)
...
-- de receptor a emisor entre ellas, pero sigue siendo Beto).
-- ============================================================================
select throws_ok(
...
-- Dirección `solicitud`: el amigo (Beto) es el EMISOR acá y también puede confirmar.
select is(
  public.confirmar_cita(
    '22222222-2222-2222-2222-222222222222',
    'cccc0002-0000-0000-0000-000000000000', 'Casa de Beto', '2026-07-26 20:00:00-05', null),
